...
#define CS35L45_DSP1_CTRL_BASE			0x02B80000
...
#define CS35L45_GLOBAL_EN_MASK			0x00000001

#define CS35L45_MEM_RDY_SHIFT			1
#define CS35L45_MEM_RDY_MASK			0x00000002

#define CS35L45_CCM_CORE_RESET_SHIFT		9
#define CS35L45_CCM_CORE_RESET_MASK		0x00000200
#define CS35L45_CCM_PM_REMAP_SHIFT		7
#define CS35L45_CCM_PM_REMAP_MASK		0x00000080
#define CS35L45_CCM_CORE_EN_SHIFT		0
#define CS35L45_CCM_CORE_EN_MASK		0x00000001

#define CS35L45_DSP1_STREAM_ARB_MSTR0_EN_SHIFT	0
#define CS35L45_DSP1_STREAM_ARB_MSTR0_EN_MASK	0x00000001

#define CS35L45_DSP1_STREAM_ARB_TX1_EN_SHIFT	0
#define CS35L45_DSP1_STREAM_ARB_TX1_EN_MASK	0x00000001
...
#define CS35L45_GLOBAL_FS_MASK			0x0000001F

#define CS35L45_BST_BPE_INST_L3_THLD_SHIFT	24
#define CS35L45_BST_BPE_INST_L3_THLD_MASK	0xFF000000
#define CS35L45_BST_BPE_INST_L2_THLD_SHIFT	16
#define CS35L45_BST_BPE_INST_L2_THLD_MASK	0x00FF0000
#define CS35L45_BST_BPE_INST_L1_THLD_SHIFT	8
#define CS35L45_BST_BPE_INST_L1_THLD_MASK	0x0000FF00
#define CS35L45_BST_BPE_INST_L0_THLD_SHIFT	0
#define CS35L45_BST_BPE_INST_L0_THLD_MASK	0x000000FF

#define CS35L45_BST_BPE_INST_L4_ILIM_SHIFT	24
#define CS35L45_BST_BPE_INST_L4_ILIM_MASK	0x7F000000
#define CS35L45_BST_BPE_INST_L3_ILIM_SHIFT	16
#define CS35L45_BST_BPE_INST_L3_ILIM_MASK	0x007F0000
#define CS35L45_BST_BPE_INST_L2_ILIM_SHIFT	8
#define CS35L45_BST_BPE_INST_L2_ILIM_MASK	0x00007F00
#define CS35L45_BST_BPE_INST_L1_ILIM_SHIFT	0
#define CS35L45_BST_BPE_INST_L1_ILIM_MASK	0x0000007F

#define CS35L45_BST_BPE_IL_LIM_THLD_HYST_SHIFT	24
#define CS35L45_BST_BPE_IL_LIM_THLD_HYST_MASK	0x1F000000
#define CS35L45_BST_BPE_IL_LIM_THLD_DEL2_SHIFT	16
#define CS35L45_BST_BPE_IL_LIM_THLD_DEL2_MASK	0x00FF0000
#define CS35L45_BST_BPE_IL_LIM_THLD_DEL1_SHIFT	8
#define CS35L45_BST_BPE_IL_LIM_THLD_DEL1_MASK	0x0000FF00
#define CS35L45_BST_BPE_IL_LIM1_THLD_SHIFT	0
#define CS35L45_BST_BPE_IL_LIM1_THLD_MASK	0x000000FF

#define CS35L45_BST_BPE_IL_LIM_DLY_HYST_SHIFT	16
#define CS35L45_BST_BPE_IL_LIM_DLY_HYST_MASK	0x001F0000
#define CS35L45_BST_BPE_IL_LIM2_DLY_SHIFT	8
#define CS35L45_BST_BPE_IL_LIM2_DLY_MASK	0x0000FF00
#define CS35L45_BST_BPE_IL_LIM1_DLY_SHIFT	0
#define CS35L45_BST_BPE_IL_LIM1_DLY_MASK	0x000000FF

#define CS35L45_BST_BPE_IL_LIM2_ATK_RATE_SHIFT	8
#define CS35L45_BST_BPE_IL_LIM2_ATK_RATE_MASK	0x00000700
#define CS35L45_BST_BPE_IL_LIM1_ATK_RATE_SHIFT	0
#define CS35L45_BST_BPE_IL_LIM1_ATK_RATE_MASK	0x00000007

#define CS35L45_BST_BPE_IL_LIM2_RLS_RATE_SHIFT	8
#define CS35L45_BST_BPE_IL_LIM2_RLS_RATE_MASK	0x00001F00
#define CS35L45_BST_BPE_IL_LIM1_RLS_RATE_SHIFT	0
#define CS35L45_BST_BPE_IL_LIM1_RLS_RATE_MASK	0x0000001F
...
#define CS35L45_ASP_WIDTH_RX_MASK		0xFF000000
#define CS35L45_ASP_WIDTH_TX_SHIFT		16
#define CS35L45_ASP_WIDTH_TX_MASK		0x00FF0000
#define CS35L45_ASP_FMT_SHIFT			8
#define CS35L45_ASP_FMT_MASK			0x00000700
#define CS35L45_ASP_BCLK_INV_SHIFT		6
#define CS35L45_ASP_BCLK_INV_MASK		0x00000040
#define CS35L45_ASP_BCLK_MSTR_SHIFT		4
#define CS35L45_ASP_BCLK_MSTR_MASK		0x00000010
#define CS35L45_ASP_FSYNC_INV_SHIFT		2
#define CS35L45_ASP_FSYNC_INV_MASK		0x00000004
#define CS35L45_ASP_FSYNC_MSTR_SHIFT		0
#define CS35L45_ASP_FSYNC_MSTR_MASK		0x00000001

#define CS35L45_ASP_WL_SHIFT			0
#define CS35L45_ASP_WL_MASK			0x3F
...
#define CS35L45_HVLV_THLD_HYS_MASK		0x00C00000
#define CS35L45_HVLV_THLD_SHIFT			16
#define CS35L45_HVLV_THLD_MASK			0x001F0000
#define CS35L45_HVLV_DLY_SHIFT			2
#define CS35L45_HVLV_DLY_MASK			0x0000001C

#define CS35L45_LDPM_GP1_BOOST_SEL_SHIFT	15
#define CS35L45_LDPM_GP1_BOOST_SEL_MASK		0x00008000
#define CS35L45_LDPM_GP1_AMP_SEL_SHIFT		14
#define CS35L45_LDPM_GP1_AMP_SEL_MASK		0x00004000
#define CS35L45_LDPM_GP1_DELAY_SHIFT		11
#define CS35L45_LDPM_GP1_DELAY_MASK		0x00003800
#define CS35L45_LDPM_GP1_PCM_THLD_SHIFT		8
#define CS35L45_LDPM_GP1_PCM_THLD_MASK		0x00000700
#define CS35L45_LDPM_GP2_IMON_SEL_SHIFT		7
#define CS35L45_LDPM_GP2_IMON_SEL_MASK		0x00000080
#define CS35L45_LDPM_GP2_VMON_SEL_SHIFT		6
#define CS35L45_LDPM_GP2_VMON_SEL_MASK		0x00000040
#define CS35L45_LDPM_GP2_DELAY_SHIFT		3
#define CS35L45_LDPM_GP2_DELAY_MASK		0x00000038
#define CS35L45_LDPM_GP2_PCM_THLD_SHIFT		0
#define CS35L45_LDPM_GP2_PCM_THLD_MASK		0x00000007

#define CS35L45_CH_HDRM_SHIFT			24
#define CS35L45_CH_HDRM_MASK			0x7F000000
#define CS35L45_CH_RATIO_SHIFT			8
#define CS35L45_CH_RATIO_MASK			0x00001F00
#define CS35L45_CH_REL_RATE_SHIFT		0
#define CS35L45_CH_REL_RATE_MASK		0x000000FF

#define CS35L45_CH_OVB_THLD1_SHIFT		16
#define CS35L45_CH_OVB_THLD1_MASK		0x00FF0000
#define CS35L45_CH_OVB_THLDDELTA_SHIFT		8
#define CS35L45_CH_OVB_THLDDELTA_MASK		0x0000FF00
#define CS35L45_CH_VDD_BST_MAX_SHIFT		0
#define CS35L45_CH_VDD_BST_MAX_MASK		0x000000FF

#define CS35L45_CH_OVB_LATCH_SHIFT		31
#define CS35L45_CH_OVB_LATCH_MASK		0x80000000
#define CS35L45_CH_OVB_RATIO_SHIFT		16
#define CS35L45_CH_OVB_RATIO_MASK		0x001F0000
#define CS35L45_CH_THLD1_OFFSET_SHIFT		0
#define CS35L45_CH_THLD1_OFFSET_MASK		0x00000FFF

#define CS35L45_AUD_MEM_DEPTH_SHIFT		0
#define CS35L45_AUD_MEM_DEPTH_MASK		0x00000007

#define CS35L45_AMP_GAIN_PCM_SHIFT		8
#define CS35L45_AMP_GAIN_PCM_MASK		0x00000300

#define CS35L45_MSM_PDN_DONE_MASK		0x00800000
#define CS35L45_MSM_PUP_DONE_MASK		0x01000000

#define CS35L45_DSP_VIRT1_MBOX_MASK		0x00100000
#define CS35L45_DSP_VIRT2_MBOX_MASK		0x00200000

#define CS35L45_GPIO_DIR_SHIFT			31
#define CS35L45_GPIO_DIR_MASK			0x80000000
#define CS35L45_GPIO_LVL_SHIFT			15
#define CS35L45_GPIO_LVL_MASK			0x00008000
#define CS35L45_GPIO_OP_CFG_SHIFT		14
#define CS35L45_GPIO_OP_CFG_MASK		0x00004000
#define CS35L45_GPIO_POL_SHIFT			12
#define CS35L45_GPIO_POL_MASK			0x00001000

#define CS35L45_GPIO_CTRL_SHIFT			20
#define CS35L45_GPIO_CTRL_MASK			0x00700000
#define CS35L45_GPIO_INVERT_SHIFT		19
#define CS35L45_GPIO_INVERT_MASK		0x00080000
