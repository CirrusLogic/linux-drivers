...
#define MADERA_CLK_73MHZ		4
#define MADERA_CLK_98MHZ		5
#define MADERA_CLK_147MHZ		6
...
#define MADERA_SAMPLE_RATE_ENUM_SIZE	14
...
extern int madera_init_gpio(struct snd_soc_codec *codec);
...
extern int madera_set_voice_cb(struct snd_soc_codec *codec,
