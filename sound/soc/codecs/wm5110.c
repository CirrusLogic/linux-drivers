...
static const struct soc_enum wm5110_dsp_output_enum =
	SOC_ENUM_SINGLE(SND_SOC_NOPM, 0, ARRAY_SIZE(wm5110_dsp_output_texts),
			wm5110_dsp_output_texts);

static const struct snd_kcontrol_new wm5110_dsp_output_mux[] = {
	SOC_DAPM_ENUM("DSP Virtual Output Mux", wm5110_dsp_output_enum),
};
...
static const struct soc_enum wm5110_memory_enum =
	SOC_ENUM_SINGLE(SND_SOC_NOPM, 0, ARRAY_SIZE(wm5110_memory_mux_texts),
			wm5110_memory_mux_texts);

static const struct snd_kcontrol_new wm5110_memory_mux[] = {
	SOC_DAPM_ENUM("DSP2 Virtual Input", wm5110_memory_enum),
	SOC_DAPM_ENUM("DSP3 Virtual Input", wm5110_memory_enum),
};
