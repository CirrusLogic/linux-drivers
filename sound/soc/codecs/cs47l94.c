...
static int cs47l94_wait_for_cp_disable(struct tacna *tacna)
{
	...
	ret = tacna_read_poll_timeout(regmap, TACNA_HP2L_CTRL, val,
	...
	ret = tacna_read_poll_timeout(regmap, TACNA_HP2R_CTRL, val,
...
SOC_ENUM("Ultrasonic 1 Freq", tacna_us_freq[0]),
SOC_ENUM("Ultrasonic 2 Freq", tacna_us_freq[1]),
...
SOC_ENUM("Ultrasonic 1 Activity Detect Decay", tacna_us_det_dcy[0]),
SOC_ENUM("Ultrasonic 2 Activity Detect Decay", tacna_us_det_dcy[1]),
...
SOC_ENUM_EXT("OUTH Rate", cs47l94_outh_rate,
	     snd_soc_get_enum_double, tacna_dac_rate_put),
...
static const struct snd_soc_dapm_route cs47l94_dapm_routes[] = {
	...
	{ "OUT2L PGA", NULL, "DAC_ASYNCCLK" },
	{ "OUT2R PGA", NULL, "DAC_ASYNCCLK" },
...
static const struct snd_soc_dapm_route cs47l94_out1_mono_routes[] = {
	{ "OUT1R PGA", NULL, "OUT1L PGA" },
};

static const struct snd_soc_dapm_route cs47l94_out2_mono_routes[] = {
	{ "OUT2R PGA", NULL, "OUT2L PGA" },
};

static const struct tacna_mono_route cs47l94_mono_routes[] = {
	{
		.routes = cs47l94_out1_mono_routes,
		.n_routes = ARRAY_SIZE(cs47l94_out1_mono_routes),
	...
	{
		.n_routes = ARRAY_SIZE(cs47l94_out2_mono_routes),
		.routes = cs47l94_out2_mono_routes,
		/* no demux - initialize mono bit from pdata */
		.cfg_reg = TACNA_OUT2L_CONTROL_1,
	},
};
...
static int cs47l94_codec_probe(struct snd_soc_codec *codec)
{
	...
	BUILD_BUG_ON(ARRAY_SIZE(cs47l94_mono_routes) >
		     ARRAY_SIZE(tacna->pdata.codec.out_mono));
	ret = tacna_init_outputs(codec, cs47l94_mono_routes,
				 ARRAY_SIZE(cs47l94_mono_routes));
	if (ret)
		return ret;
