...
static const struct soc_enum cs47l24_dsp_output_enum =
	SOC_ENUM_SINGLE(SND_SOC_NOPM, 0, ARRAY_SIZE(cs47l24_dsp_output_texts),
			cs47l24_dsp_output_texts);

static const struct snd_kcontrol_new cs47l24_dsp_output_mux[] = {
	SOC_DAPM_ENUM("DSP Virtual Output Mux", cs47l24_dsp_output_enum),
};
...
static const struct soc_enum cs47l24_memory_enum =
	SOC_ENUM_SINGLE(SND_SOC_NOPM, 0, ARRAY_SIZE(cs47l24_memory_mux_texts),
			cs47l24_memory_mux_texts);

static const struct snd_kcontrol_new cs47l24_memory_mux[] = {
	SOC_DAPM_ENUM("DSP2 Virtual Input", cs47l24_memory_enum),
	SOC_DAPM_ENUM("DSP3 Virtual Input", cs47l24_memory_enum),
};
