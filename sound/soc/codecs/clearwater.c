...
SOC_ENUM("ASRC1 Rate 1", clearwater_asrc1_rate[0]),
SOC_ENUM("ASRC1 Rate 2", clearwater_asrc1_rate[1]),
SOC_ENUM("ASRC2 Rate 1", clearwater_asrc2_rate[0]),
SOC_ENUM("ASRC2 Rate 2", clearwater_asrc2_rate[1]),
