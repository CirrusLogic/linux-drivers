...
#define TACNA_AO_MIXER_ENUMS(name, base_reg) \
	TACNA_AO_MUX_ENUMS(name##_in1, base_reg);     \
	TACNA_AO_MUX_ENUMS(name##_in2, base_reg + 4); \
	TACNA_AO_MUX_ENUMS(name##_in3, base_reg + 8); \
	TACNA_AO_MUX_ENUMS(name##_in4, base_reg + 12)
...
const struct soc_enum cs47l96_ao_sample_rate[] = {
...
static const char * const cs47l96_ao_mixer_texts[] = {
	...
	"IN7LAO",
	"IN7RAO",
	"AO Bridge 2 channel 1",
	"AO Bridge 2 channel 2",
	"AO Bridge 2 channel 3",
	"AO Bridge 2 channel 4",
	"AO Bridge 2 channel 5",
	"AO Bridge 2 channel 6",
	"AO Bridge 2 channel 7",
	"AO Bridge 2 channel 8",
};
...
TACNA_AO_MIXER_ENUMS(ASP1AOTX1, TACNA_ASP1AOTX1_INPUT1);
TACNA_AO_MIXER_ENUMS(ASP1AOTX2, TACNA_ASP1AOTX2_INPUT1);
TACNA_AO_MIXER_ENUMS(ASP1AOTX3, TACNA_ASP1AOTX3_INPUT1);
TACNA_AO_MIXER_ENUMS(ASP1AOTX4, TACNA_ASP1AOTX4_INPUT1);

TACNA_AO_MIXER_ENUMS(DSP1AORX1, TACNA_DSP1AORX1_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX2, TACNA_DSP1AORX2_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX3, TACNA_DSP1AORX3_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX4, TACNA_DSP1AORX4_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX5, TACNA_DSP1AORX5_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX6, TACNA_DSP1AORX6_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX7, TACNA_DSP1AORX7_INPUT1);
TACNA_AO_MIXER_ENUMS(DSP1AORX8, TACNA_DSP1AORX8_INPUT1);
...
TACNA_MIXER_WIDGETS(ASP1AOTX1, "ASP1AOTX1"),
TACNA_MIXER_WIDGETS(ASP1AOTX2, "ASP1AOTX2"),
TACNA_MIXER_WIDGETS(ASP1AOTX3, "ASP1AOTX3"),
TACNA_MIXER_WIDGETS(ASP1AOTX4, "ASP1AOTX4"),

TACNA_MIXER_WIDGETS(DSP1AORX1, "DSP1AORX1"),
TACNA_MIXER_WIDGETS(DSP1AORX2, "DSP1AORX2"),
TACNA_MIXER_WIDGETS(DSP1AORX3, "DSP1AORX3"),
TACNA_MIXER_WIDGETS(DSP1AORX4, "DSP1AORX4"),
TACNA_MIXER_WIDGETS(DSP1AORX5, "DSP1AORX5"),
TACNA_MIXER_WIDGETS(DSP1AORX6, "DSP1AORX6"),
TACNA_MIXER_WIDGETS(DSP1AORX7, "DSP1AORX7"),
TACNA_MIXER_WIDGETS(DSP1AORX8, "DSP1AORX8"),
...
static const struct snd_soc_dapm_route cs47l96_ao_dapm_routes[] = {
	...
	TACNA_MIXER_ROUTES("ASP1AOTX1", "ASP1AOTX1"),
	TACNA_MIXER_ROUTES("ASP1AOTX2", "ASP1AOTX2"),
	TACNA_MIXER_ROUTES("ASP1AOTX3", "ASP1AOTX3"),
	TACNA_MIXER_ROUTES("ASP1AOTX4", "ASP1AOTX4"),
...
static const struct snd_kcontrol_new cs47l96_ao_dsp1ao_rate_controls[] = {
	...
	SOC_ENUM_EXT("DSP1AORX2 Rate", tacna_dsp1_rx_rate_enum[1],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AORX3 Rate", tacna_dsp1_rx_rate_enum[2],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AORX4 Rate", tacna_dsp1_rx_rate_enum[3],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AORX5 Rate", tacna_dsp1_rx_rate_enum[4],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AORX6 Rate", tacna_dsp1_rx_rate_enum[5],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AORX7 Rate", tacna_dsp1_rx_rate_enum[6],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AORX8 Rate", tacna_dsp1_rx_rate_enum[7],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX1 Rate", tacna_dsp1_tx_rate_enum[0],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX2 Rate", tacna_dsp1_tx_rate_enum[1],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX3 Rate", tacna_dsp1_tx_rate_enum[2],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX4 Rate", tacna_dsp1_tx_rate_enum[3],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX5 Rate", tacna_dsp1_tx_rate_enum[4],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX6 Rate", tacna_dsp1_tx_rate_enum[5],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX7 Rate", tacna_dsp1_tx_rate_enum[6],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
	SOC_ENUM_EXT("DSP1AOTX8 Rate", tacna_dsp1_tx_rate_enum[7],
		     tacna_dsp_rate_get, tacna_dsp_rate_put),
};
