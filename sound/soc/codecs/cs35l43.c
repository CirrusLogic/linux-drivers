...
static int cs35l43_dsp_reset(struct cs35l43_private *cs35l43)
{
	...
	do {
		...
		wm_adsp_read_ctl(&cs35l43->dsp, "HALO_STATE",
			WMFW_ADSP2_XM, cs35l43->dsp.fw_id, &val, sizeof(u32));
		val = be32_to_cpu(val);
...
static int cs35l43_check_dsp_regs(struct cs35l43_private *cs35l43)
{
	...
	ret = wm_adsp_read_ctl(&cs35l43->dsp, "HALO_STATE", WMFW_ADSP2_XM, cs35l43->dsp.fw_id,
				&val, sizeof(u32));
	if (ret < 0) {
...
static int cs35l43_log_dsp_err(struct cs35l43_private *cs35l43)
{
	...
	struct cs35l43_dsp_reg regs[] = {
		...
		{ "AUDIO_STATE",	0x5f212 },
		{ "ERROR",		0x5f212 },
		{ "HALO_STATE",		cs35l43->dsp.fw_id },
		{ "HALO_HEARTBEAT",	cs35l43->dsp.fw_id },
		{ "AUDIO_BLK_SIZE",	cs35l43->dsp.fw_id },
