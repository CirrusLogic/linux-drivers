...
static int __devinit wm8997_probe(struct platform_device *pdev)
{
...
static int __devexit wm8997_remove(struct platform_device *pdev)
{
...
static struct platform_driver wm8997_codec_driver = {
	...
	.probe = wm8997_probe,
	.remove = __devexit_p(wm8997_remove),
};
