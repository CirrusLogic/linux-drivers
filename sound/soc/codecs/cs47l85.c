...
SND_SOC_DAPM_MUX("DSP4 Trigger Output", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_trigger_output_mux[3]),
SND_SOC_DAPM_MUX("DSP5 Trigger Output", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_trigger_output_mux[4]),
SND_SOC_DAPM_MUX("DSP6 Trigger Output", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_trigger_output_mux[5]),
SND_SOC_DAPM_MUX("DSP7 Trigger Output", SND_SOC_NOPM, 0, 0,
...
static const struct snd_soc_dapm_route cs47l85_dapm_routes[] = {
	...
	{ "DSP4 Trigger Output", "Enable", "DSP4" },
	{ "DSP5 Trigger Output", "Enable", "DSP5" },
	{ "DSP6 Trigger Output", "Enable", "DSP6" },
	{ "DSP7 Trigger Output", "Enable", "DSP7" },
