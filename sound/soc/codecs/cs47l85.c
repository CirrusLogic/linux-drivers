...
#define CS47L85_DEFAULT_FRAGMENTS       1
#define CS47L85_DEFAULT_FRAGMENT_SIZE   4096

struct cs47l85_compr {
	struct mutex lock;
...
struct cs47l85 {
	...
	struct cs47l85_compr compr_info;
};

static const unsigned int cs47l85_fx_inputs[] = {
...
static const unsigned int cs47l85_out_inputs[] = {
	...
	MADERA_MIXER_INPUTS_4_N(MADERA_OUT4RMIX_INPUT_1_SOURCE, 2),
	MADERA_MIXER_INPUTS_4_N(MADERA_OUT5LMIX_INPUT_1_SOURCE, 2),
	MADERA_MIXER_INPUTS_4_N(MADERA_OUT5RMIX_INPUT_1_SOURCE, 2),
	MADERA_MIXER_INPUTS_4_N(MADERA_OUT6LMIX_INPUT_1_SOURCE, 2),
	MADERA_MIXER_INPUTS_4_N(MADERA_OUT6RMIX_INPUT_1_SOURCE, 2),
};

static const unsigned int cs47l85_spd1_inputs[] = {
	MADERA_MIXER_INPUTS_2_N(MADERA_SPDIFTX1MIX_INPUT_1_SOURCE, 8),
};

static const unsigned int cs47l85_dsp1_inputs[] = {
	MADERA_DSP_MIXER_INPUTS(MADERA_DSP1LMIX_INPUT_1_SOURCE),
};

static const unsigned int cs47l85_dsp2_inputs[] = {
	MADERA_DSP_MIXER_INPUTS(MADERA_DSP2LMIX_INPUT_1_SOURCE),
};

static const unsigned int cs47l85_dsp3_inputs[] = {
	MADERA_DSP_MIXER_INPUTS(MADERA_DSP3LMIX_INPUT_1_SOURCE),
};

static const unsigned int cs47l85_dsp4_inputs[] = {
	MADERA_DSP_MIXER_INPUTS(MADERA_DSP4LMIX_INPUT_1_SOURCE),
};

static const unsigned int cs47l85_dsp5_inputs[] = {
	MADERA_DSP_MIXER_INPUTS(MADERA_DSP5LMIX_INPUT_1_SOURCE),
};

static const unsigned int cs47l85_dsp6_inputs[] = {
	MADERA_DSP_MIXER_INPUTS(MADERA_DSP6LMIX_INPUT_1_SOURCE),
};

static const unsigned int cs47l85_dsp7_inputs[] = {
...
static const char * const cs47l85_inmux_texts[] = {
	"A",
	"B",
};
...
static const struct snd_kcontrol_new cs47l85_in2mux[2] = {
	SOC_DAPM_ENUM("IN2L Mux", cs47l85_in2muxl_enum),
	SOC_DAPM_ENUM("IN2R Mux", cs47l85_in2muxr_enum),
};

static int cs47l85_get_sources(unsigned int reg,
				const unsigned int **cur_sources, int *lim)
{
	...
	case MADERA_FX_CTRL1:
		*cur_sources = cs47l85_fx_inputs;
		*lim = ARRAY_SIZE(cs47l85_fx_inputs);
		break;
	case MADERA_ASRC1_RATE1:
		*cur_sources = cs47l85_asrc1_1_inputs;
		*lim = ARRAY_SIZE(cs47l85_asrc1_1_inputs);
		break;
	case MADERA_ASRC1_RATE2:
		*cur_sources = cs47l85_asrc1_2_inputs;
		*lim = ARRAY_SIZE(cs47l85_asrc1_2_inputs);
		break;
	case MADERA_ASRC2_RATE1:
		*cur_sources = cs47l85_asrc2_1_inputs;
		*lim = ARRAY_SIZE(cs47l85_asrc2_1_inputs);
		break;
	case MADERA_ASRC2_RATE2:
		*cur_sources = cs47l85_asrc2_2_inputs;
		*lim = ARRAY_SIZE(cs47l85_asrc2_2_inputs);
		break;
	case MADERA_ISRC_1_CTRL_1:
		*cur_sources = cs47l85_isrc1_fsh_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc1_fsh_inputs);
		break;
	case MADERA_ISRC_1_CTRL_2:
		*cur_sources = cs47l85_isrc1_fsl_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc1_fsl_inputs);
		break;
	case MADERA_ISRC_2_CTRL_1:
		*cur_sources = cs47l85_isrc2_fsh_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc2_fsh_inputs);
		break;
	case MADERA_ISRC_2_CTRL_2:
		*cur_sources = cs47l85_isrc2_fsl_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc2_fsl_inputs);
		break;
	case MADERA_ISRC_3_CTRL_1:
		*cur_sources = cs47l85_isrc3_fsh_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc3_fsh_inputs);
		break;
	case MADERA_ISRC_3_CTRL_2:
		*cur_sources = cs47l85_isrc3_fsl_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc3_fsl_inputs);
		break;
	case MADERA_ISRC_4_CTRL_1:
		*cur_sources = cs47l85_isrc4_fsh_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc4_fsh_inputs);
		break;
	case MADERA_ISRC_4_CTRL_2:
		*cur_sources = cs47l85_isrc4_fsl_inputs;
		*lim = ARRAY_SIZE(cs47l85_isrc4_fsl_inputs);
		break;
	case MADERA_OUTPUT_RATE_1:
		*cur_sources = cs47l85_out_inputs;
		*lim = ARRAY_SIZE(cs47l85_out_inputs);
		break;
	case MADERA_SPD1_TX_CONTROL:
		*cur_sources = cs47l85_spd1_inputs;
		*lim = ARRAY_SIZE(cs47l85_spd1_inputs);
		break;
	case MADERA_DSP1_CONFIG_1:
		*cur_sources = cs47l85_dsp1_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp1_inputs);
		break;
	case MADERA_DSP2_CONFIG_1:
		*cur_sources = cs47l85_dsp2_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp2_inputs);
		break;
	case MADERA_DSP3_CONFIG_1:
		*cur_sources = cs47l85_dsp3_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp3_inputs);
		break;
	case MADERA_DSP4_CONFIG_1:
		*cur_sources = cs47l85_dsp4_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp4_inputs);
		break;
	case MADERA_DSP5_CONFIG_1:
		*cur_sources = cs47l85_dsp5_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp5_inputs);
		break;
	case MADERA_DSP6_CONFIG_1:
		*cur_sources = cs47l85_dsp6_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp6_inputs);
		break;
	case MADERA_DSP7_CONFIG_1:
		*cur_sources = cs47l85_dsp7_inputs;
		*lim = ARRAY_SIZE(cs47l85_dsp7_inputs);
		break;
	default:
		ret = -EINVAL;
	}
				 ...
				 int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		ret = madera_set_adsp_clk(&cs47l85->core.adsp[w->shift], freq);
		if (ret)
			return ret;

		if (w->shift == 5) {
			mutex_lock(&cs47l85->compr_info.lock);
			cs47l85->compr_info.trig = false;
			mutex_unlock(&cs47l85->compr_info.lock);
		}
		break;
	default:
		break;
...
static void cs47l85_hp_post_enable(struct snd_soc_dapm_widget *w)
{
	...
	case MADERA_OUT1R_ENA_SHIFT:
		val = snd_soc_read(w->codec, MADERA_OUTPUT_ENABLES_1);
...
static void cs47l85_hp_post_disable(struct snd_soc_dapm_widget *w)
{
	switch (w->shift) {
	case MADERA_OUT1L_ENA_SHIFT:
		snd_soc_write(w->codec, MADERA_DCS_HP1L_CONTROL, 0x2006);
		break;
	case MADERA_OUT1R_ENA_SHIFT:
		snd_soc_write(w->codec, MADERA_DCS_HP1R_CONTROL, 0x2006);
		break;
	default:
		return;
	}
...
SOC_ENUM_EXT("IN1 Mode", madera_ip_mode[0],
		snd_soc_get_enum_double, madera_ip_mode_put),
SOC_ENUM_EXT("IN2 Mode", madera_ip_mode[1],
		snd_soc_get_enum_double, madera_ip_mode_put),
SOC_ENUM_EXT("IN3 Mode", madera_ip_mode[2],
		snd_soc_get_enum_double, madera_ip_mode_put),
...
MADERA_FRF_BYTES("FRF COEFF 3R", MADERA_FRF_COEFFICIENT_3R_1,
				 MADERA_FRF_COEFFICIENT_LEN),
MADERA_FRF_BYTES("FRF COEFF 4L", MADERA_FRF_COEFFICIENT_4L_1,
				 MADERA_FRF_COEFFICIENT_LEN),
MADERA_FRF_BYTES("FRF COEFF 4R", MADERA_FRF_COEFFICIENT_4R_1,
				 MADERA_FRF_COEFFICIENT_LEN),
MADERA_FRF_BYTES("FRF COEFF 5L", MADERA_FRF_COEFFICIENT_5L_1,
				 MADERA_FRF_COEFFICIENT_LEN),
MADERA_FRF_BYTES("FRF COEFF 5R", MADERA_FRF_COEFFICIENT_5R_1,
				 MADERA_FRF_COEFFICIENT_LEN),
MADERA_FRF_BYTES("FRF COEFF 6L", MADERA_FRF_COEFFICIENT_6L_1,
				 MADERA_FRF_COEFFICIENT_LEN),
MADERA_FRF_BYTES("FRF COEFF 6R", MADERA_FRF_COEFFICIENT_6R_1,
				 MADERA_FRF_COEFFICIENT_LEN),
...
MADERA_RATE_ENUM("SPDIF Rate", madera_spdif_rate),
...
MADERA_GAINMUX_CONTROLS("SPDIFTX1", MADERA_SPDIFTX1MIX_INPUT_1_SOURCE),
MADERA_GAINMUX_CONTROLS("SPDIFTX2", MADERA_SPDIFTX2MIX_INPUT_1_SOURCE),
};
...
MADERA_MUX_ENUMS(SPD1TX1, MADERA_SPDIFTX1MIX_INPUT_1_SOURCE);
MADERA_MUX_ENUMS(SPD1TX2, MADERA_SPDIFTX2MIX_INPUT_1_SOURCE);
...
static const char * const cs47l85_memory_mux_texts[] = {
	"None",
	"Shared Memory",
};

static const struct soc_enum cs47l85_memory_enum =
	SOC_ENUM_SINGLE(SND_SOC_NOPM, 0, ARRAY_SIZE(cs47l85_memory_mux_texts),
			cs47l85_memory_mux_texts);

static const struct snd_kcontrol_new cs47l85_memory_mux[] = {
	SOC_DAPM_ENUM("DSP2 Virtual Input", cs47l85_memory_enum),
	SOC_DAPM_ENUM("DSP3 Virtual Input", cs47l85_memory_enum),
};
...
SND_SOC_DAPM_MUX("IN1L Mux", SND_SOC_NOPM, 0, 0, &cs47l85_in1mux),
SND_SOC_DAPM_MUX("IN2L Mux", SND_SOC_NOPM, 0, 0, &cs47l85_in2mux[0]),
SND_SOC_DAPM_MUX("IN2R Mux", SND_SOC_NOPM, 0, 0, &cs47l85_in2mux[1]),
...
SND_SOC_DAPM_PGA("ISRC1DEC1", MADERA_ISRC_1_CTRL_3,
		 MADERA_ISRC1_DEC0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC1INT1", MADERA_ISRC_1_CTRL_3,
		 MADERA_ISRC1_INT0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC2DEC1", MADERA_ISRC_2_CTRL_3,
		 MADERA_ISRC2_DEC0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC2INT1", MADERA_ISRC_2_CTRL_3,
		 MADERA_ISRC2_INT0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC3DEC1", MADERA_ISRC_3_CTRL_3,
		 MADERA_ISRC3_DEC0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC3INT1", MADERA_ISRC_3_CTRL_3,
		 MADERA_ISRC3_INT0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC4DEC1", MADERA_ISRC_4_CTRL_3,
		 MADERA_ISRC4_DEC0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_PGA("ISRC4INT1", MADERA_ISRC_4_CTRL_3,
		 MADERA_ISRC4_INT0_ENA_SHIFT, 0, NULL, 0),
...
SND_SOC_DAPM_MUX("DSP4 Virtual Output Mux", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_virt_output_mux[3]),
SND_SOC_DAPM_MUX("DSP5 Virtual Output Mux", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_virt_output_mux[4]),
SND_SOC_DAPM_MUX("DSP6 Virtual Output Mux", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_virt_output_mux[5]),
SND_SOC_DAPM_MUX("DSP7 Virtual Output Mux", SND_SOC_NOPM, 0, 0,
		      &madera_dsp_virt_output_mux[6]),
...
static const struct snd_soc_dapm_route cs47l85_dapm_routes[] = {
	...
	{ "Voice Control CPU6", NULL, "Voice Control DSP6" },
	{ "Voice Control DSP6", NULL, "DSP6" },
	{ "Voice Control CPU6", NULL, "SYSCLK" },
	{ "Voice Control DSP6", NULL, "SYSCLK" },
	...
	{ "DSP Virtual Output", NULL, "DSP4 Virtual Output Mux" },
	{ "DSP Virtual Output", NULL, "DSP5 Virtual Output Mux" },
	{ "DSP Virtual Output", NULL, "DSP6 Virtual Output Mux" },
	{ "DSP Virtual Output", NULL, "DSP7 Virtual Output Mux" },

	{ "DSP1 Virtual Output Mux", "DSP", "DSP1" },
	{ "DSP2 Virtual Output Mux", "DSP", "DSP2" },
	{ "DSP3 Virtual Output Mux", "DSP", "DSP3" },
	{ "DSP4 Virtual Output Mux", "DSP", "DSP4" },
	{ "DSP5 Virtual Output Mux", "DSP", "DSP5" },
	{ "DSP6 Virtual Output Mux", "DSP", "DSP6" },
	{ "DSP7 Virtual Output Mux", "DSP", "DSP7" },
			  ...
			  unsigned int Fref, unsigned int Fout)
{
	...
	switch (fll_id) {
	case MADERA_FLL1:
		return madera_set_fll(&cs47l85->fll[0], source, Fref, Fout);
	case MADERA_FLL2:
		return madera_set_fll(&cs47l85->fll[1], source, Fref, Fout);
	case MADERA_FLL3:
		return madera_set_fll(&cs47l85->fll[2], source, Fref, Fout);
...
static struct snd_soc_dai_driver cs47l85_dai[] = {
	...
	{
		.name = "cs47l85-dsp6-voicectrl",
		.capture = {
			.stream_name = "Voice Control DSP6",
			.channels_min = 1,
			.channels_max = 2,
			.rates = MADERA_RATES,
			.formats = MADERA_FORMATS,
...
static irqreturn_t adsp2_irq(int irq, void *data)
{
	...
	if (!cs47l85->compr_info.trig &&
	    cs47l85->core.adsp[5].fw_features.ez2control_trigger &&
	    cs47l85->core.adsp[5].running) {
		if (cs47l85->core.madera->pdata.voice_trigger)
			cs47l85->core.madera->pdata.voice_trigger();
		cs47l85->compr_info.trig = true;
	}

	if (!cs47l85->compr_info.allocated)
		goto out;

	ret = wm_adsp_stream_handle_irq(cs47l85->compr_info.adsp);
	if (ret < 0) {
		dev_err(cs47l85->core.madera->dev,
			"Failed to capture DSP data: %d\n",
			ret);
		goto out;
	}

	cs47l85->compr_info.total_copied += ret;

	avail = wm_adsp_stream_avail(cs47l85->compr_info.adsp);
	if (avail > CS47L85_DEFAULT_FRAGMENT_SIZE)
		snd_compr_fragment_elapsed(cs47l85->compr_info.stream);
...
static int cs47l85_open(struct snd_compr_stream *stream)
{
	...
	struct cs47l85 *cs47l85 = snd_soc_codec_get_drvdata(rtd->codec);
	struct madera *madera = cs47l85->core.madera;
	int n_adsp, ret = 0;

	mutex_lock(&cs47l85->compr_info.lock);

	if (cs47l85->compr_info.stream) {
		ret = -EBUSY;
		goto out;
	}

	if (strcmp(rtd->codec_dai->name, "cs47l85-dsp6-voicectrl") == 0) {
		n_adsp = 5;
	} else if (strcmp(rtd->codec_dai->name, "cs47l85-dsp1-trace") == 0) {
		n_adsp = 0;
	} else {
		dev_err(madera->dev,
	...
	if (!wm_adsp_compress_supported(&cs47l85->core.adsp[n_adsp], stream)) {
		dev_err(madera->dev,
	...
	cs47l85->compr_info.adsp = &cs47l85->core.adsp[n_adsp];
	cs47l85->compr_info.stream = stream;
out:
	mutex_unlock(&cs47l85->compr_info.lock);
...
static int cs47l85_free(struct snd_compr_stream *stream)
{
	struct snd_soc_pcm_runtime *rtd = stream->private_data;
	struct cs47l85 *cs47l85 = snd_soc_codec_get_drvdata(rtd->codec);
	...
	cs47l85->compr_info.allocated = false;
	cs47l85->compr_info.stream = NULL;
	cs47l85->compr_info.total_copied = 0;

	wm_adsp_stream_free(cs47l85->compr_info.adsp);
...
static int cs47l85_set_params(struct snd_compr_stream *stream,
			     struct snd_compr_params *params)
{
	struct snd_soc_pcm_runtime *rtd = stream->private_data;
	struct cs47l85 *cs47l85 = snd_soc_codec_get_drvdata(rtd->codec);
	struct madera *madera = cs47l85->core.madera;
	struct cs47l85_compr *compr = &cs47l85->compr_info;
	int ret = 0;
...
static int cs47l85_get_params(struct snd_compr_stream *stream,
			     struct snd_codec *params)
{
	return 0;
}

static int cs47l85_trigger(struct snd_compr_stream *stream, int cmd)
{
	struct snd_soc_pcm_runtime *rtd = stream->private_data;
	struct cs47l85 *cs47l85 = snd_soc_codec_get_drvdata(rtd->codec);
	struct madera *madera = cs47l85->core.madera;
	...
	case SNDRV_PCM_TRIGGER_START:
		ret = wm_adsp_stream_start(cs47l85->compr_info.adsp);
	...
	*/
	if (pending)
		regmap_write(madera->regmap,
			     MADERA_ADSP2_IRQ0, MADERA_DSP_IRQ1);

	return ret;
}

static int cs47l85_pointer(struct snd_compr_stream *stream,
			  struct snd_compr_tstamp *tstamp)
{
	...
	tstamp->copied_total = cs47l85->compr_info.total_copied;
	mutex_unlock(&cs47l85->compr_info.lock);

	return 0;
}

static int cs47l85_copy(struct snd_compr_stream *stream, char __user *buf,
		       size_t count)
{
	struct snd_soc_pcm_runtime *rtd = stream->private_data;
	struct cs47l85 *cs47l85 = snd_soc_codec_get_drvdata(rtd->codec);
	...
	if (stream->direction == SND_COMPRESS_PLAYBACK)
		...
		ret = wm_adsp_stream_read(cs47l85->compr_info.adsp, buf, count);
...
static int cs47l85_get_caps(struct snd_compr_stream *stream,
			   struct snd_compr_caps *caps)
{
	...
	caps->min_fragment_size = CS47L85_DEFAULT_FRAGMENT_SIZE;
	caps->max_fragment_size = CS47L85_DEFAULT_FRAGMENT_SIZE;
	caps->min_fragments = CS47L85_DEFAULT_FRAGMENTS;
	caps->max_fragments = CS47L85_DEFAULT_FRAGMENTS;

	wm_adsp_get_caps(cs47l85->compr_info.adsp, stream, caps);
...
static int cs47l85_get_codec_caps(struct snd_compr_stream *stream,
...
static int cs47l85_codec_probe(struct snd_soc_codec *codec)
{
	...
	ret = madera_init_dsp_irq(codec, adsp2_irq, cs47l85);
	if (ret)
		return ret;
...
static struct snd_compr_ops cs47l85_compr_ops = {
	.open = cs47l85_open,
	.free = cs47l85_free,
	.set_params = cs47l85_set_params,
	.get_params = cs47l85_get_params,
	.trigger = cs47l85_trigger,
	.pointer = cs47l85_pointer,
	.copy = cs47l85_copy,
	.get_caps = cs47l85_get_caps,
	.get_codec_caps = cs47l85_get_codec_caps,
};
...
static int cs47l85_probe(struct platform_device *pdev)
{
	...
	mutex_init(&cs47l85->compr_info.lock);
...
error:
	mutex_destroy(&cs47l85->compr_info.lock);
