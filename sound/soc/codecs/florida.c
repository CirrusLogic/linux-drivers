...
SND_SOC_DAPM_VIRT_MUX("RXANCL NG Mux", SND_SOC_NOPM, 0, 0, &florida_anc_ng_mux),
...
SND_SOC_DAPM_VIRT_MUX("RXANCR NG Mux", SND_SOC_NOPM, 0, 0, &florida_anc_ng_mux),
...
static struct platform_driver florida_codec_driver = {
	...
	.probe = florida_probe,
	.remove = __devexit_p(florida_remove),
};
