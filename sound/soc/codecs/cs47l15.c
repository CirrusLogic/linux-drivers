...
/* Mid-mode registers */
#define GAINES_ADC_INT_BIAS_MASK	0x3800
#define GAINES_ADC_INT_BIAS_SHIFT	11
#define GAINES_PGA_BIAS_SEL_MASK	0x03
#define GAINES_PGA_BIAS_SEL_SHIFT	0
...
static SOC_ENUM_SINGLE_DECL(cs47l15_in1muxl_enum,
			    ARIZONA_ADC_DIGITAL_VOLUME_1L,
			    ARIZONA_IN1L_SRC_SHIFT,
			    cs47l15_inmux_texts);

static SOC_ENUM_SINGLE_DECL(cs47l15_in1muxr_enum,
			    ARIZONA_ADC_DIGITAL_VOLUME_1R,
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	case 0:
		...
		snd_soc_update_bits(codec, GAINES_ADC_INT_BIAS,
				    GAINES_ADC_INT_BIAS_MASK,
				    4 << GAINES_ADC_INT_BIAS_SHIFT);
		snd_soc_update_bits(codec, GAINES_PGA_BIAS_SEL,
				    GAINES_PGA_BIAS_SEL_MASK,
				    0);
	...
	default:
		...
		snd_soc_update_bits(codec, GAINES_ADC_INT_BIAS,
				    GAINES_ADC_INT_BIAS_MASK,
				    1 << GAINES_ADC_INT_BIAS_SHIFT);
		snd_soc_update_bits(codec, GAINES_PGA_BIAS_SEL,
				    GAINES_PGA_BIAS_SEL_MASK,
				    3 << GAINES_PGA_BIAS_SEL_SHIFT);
...
static const struct snd_kcontrol_new cs47l15_dsp_output_mux[] = {
	SOC_DAPM_ENUM("DSP Virtual Output Mux", cs47l15_dsp_output_enum),
};
...
static const struct snd_kcontrol_new cs47l15_aec_loopback_mux =
	SOC_DAPM_ENUM("AEC Loopback", cs47l15_aec_loopback);
...
{
	struct cs47l15_priv *priv = dev_get_drvdata(dev);
