...
static irqreturn_t cs47l15_adsp2_irq(int irq, void *data)
{
	...
	/*
	 * If firmware is trigger-only, do not expect a compressed
	 * stream but notify the trigger occurred
	 */
	if (priv->adsp[0].fw_id == 0xd000d) {
...
static int cs47l15_codec_probe(struct snd_soc_codec *codec)
{
	...
	cs47l15->core.madera->dapm = snd_soc_codec_get_dapm(codec);
