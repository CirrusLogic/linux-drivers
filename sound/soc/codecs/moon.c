...
SOC_VALUE_ENUM_EXT("IN1L Rate", moon_input_rate[0],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN1R Rate", moon_input_rate[1],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN2L Rate", moon_input_rate[2],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN2R Rate", moon_input_rate[3],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN3L Rate", moon_input_rate[4],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN3R Rate", moon_input_rate[5],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN4L Rate", moon_input_rate[6],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN4R Rate", moon_input_rate[7],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN5L Rate", moon_input_rate[8],
	snd_soc_get_value_enum_double, moon_in_rate_put),
SOC_VALUE_ENUM_EXT("IN5R Rate", moon_input_rate[9],
	snd_soc_get_value_enum_double, moon_in_rate_put),

SOC_VALUE_ENUM_EXT("DFC1RX Width", moon_dfc_width[0],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC1RX Type", moon_dfc_type[0],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC1TX Width", moon_dfc_width[1],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC1TX Type", moon_dfc_type[1],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC2RX Width", moon_dfc_width[2],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC2RX Type", moon_dfc_type[2],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC2TX Width", moon_dfc_width[3],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC2TX Type", moon_dfc_type[3],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC3RX Width", moon_dfc_width[4],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC3RX Type", moon_dfc_type[4],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC3TX Width", moon_dfc_width[5],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC3TX Type", moon_dfc_type[5],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC4RX Width", moon_dfc_width[6],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC4RX Type", moon_dfc_type[6],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC4TX Width", moon_dfc_width[7],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC4TX Type", moon_dfc_type[7],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC5RX Width", moon_dfc_width[8],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC5RX Type", moon_dfc_type[8],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC5TX Width", moon_dfc_width[9],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC5TX Type", moon_dfc_type[9],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC6RX Width", moon_dfc_width[10],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC6RX Type", moon_dfc_type[10],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC6TX Width", moon_dfc_width[11],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC6TX Type", moon_dfc_type[11],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC7RX Width", moon_dfc_width[12],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC7RX Type", moon_dfc_type[12],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC7TX Width", moon_dfc_width[13],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC7TX Type", moon_dfc_type[13],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC8RX Width", moon_dfc_width[14],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC8RX Type", moon_dfc_type[14],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC8TX Width", moon_dfc_width[15],
	snd_soc_get_value_enum_double, moon_dfc_put),
SOC_VALUE_ENUM_EXT("DFC8TX Type", moon_dfc_type[15],
	snd_soc_get_value_enum_double, moon_dfc_put),
...
static const struct soc_enum moon_dsp_output_enum =
	SOC_ENUM_SINGLE(0, 0, ARRAY_SIZE(moon_dsp_output_texts),
			moon_dsp_output_texts);

static const struct snd_kcontrol_new moon_dsp_output_mux[] = {
	SOC_DAPM_ENUM_VIRT("DSP Virtual Output Mux", moon_dsp_output_enum),
};
...
static const struct soc_enum moon_memory_enum =
	SOC_ENUM_SINGLE(0, 0, ARRAY_SIZE(moon_memory_mux_texts),
			moon_memory_mux_texts);

static const struct snd_kcontrol_new moon_memory_mux[] = {
	SOC_DAPM_ENUM_VIRT("DSP2 Virtual Input", moon_memory_enum),
	SOC_DAPM_ENUM_VIRT("DSP3 Virtual Input", moon_memory_enum),
};
...
static const struct snd_kcontrol_new moon_aec_loopback_mux =
	SOC_DAPM_VALUE_ENUM("AEC Loopback", moon_aec_loopback);
...
SND_SOC_DAPM_REGULATOR_SUPPLY("DBVDD4", 0),
