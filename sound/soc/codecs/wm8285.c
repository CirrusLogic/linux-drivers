...
ARIZONA_MIXER_ENUMS(DSP5L, WM8285_DSP5LMIX_INPUT_1_SOURCE);
ARIZONA_MIXER_ENUMS(DSP5R, WM8285_DSP5RMIX_INPUT_1_SOURCE);
ARIZONA_DSP_AUX_ENUMS(DSP5, WM8285_DSP5AUX1MIX_INPUT_1_SOURCE);

ARIZONA_MIXER_ENUMS(DSP6L, WM8285_DSP6LMIX_INPUT_1_SOURCE);
ARIZONA_MIXER_ENUMS(DSP6R, WM8285_DSP6RMIX_INPUT_1_SOURCE);
ARIZONA_DSP_AUX_ENUMS(DSP6, WM8285_DSP6AUX1MIX_INPUT_1_SOURCE);

ARIZONA_MIXER_ENUMS(DSP7L, WM8285_DSP7LMIX_INPUT_1_SOURCE);
ARIZONA_MIXER_ENUMS(DSP7R, WM8285_DSP7RMIX_INPUT_1_SOURCE);
ARIZONA_DSP_AUX_ENUMS(DSP7, WM8285_DSP7AUX1MIX_INPUT_1_SOURCE);
...
ARIZONA_MIXER_ENUMS(AIF2TX7, ARIZONA_AIF2TX7MIX_INPUT_1_SOURCE);
ARIZONA_MIXER_ENUMS(AIF2TX8, ARIZONA_AIF2TX8MIX_INPUT_1_SOURCE);
...
ARIZONA_MUX_ENUMS(ISRC4INT1, ARIZONA_ISRC4INT1MIX_INPUT_1_SOURCE);
ARIZONA_MUX_ENUMS(ISRC4INT2, ARIZONA_ISRC4INT2MIX_INPUT_1_SOURCE);

ARIZONA_MUX_ENUMS(ISRC4DEC1, ARIZONA_ISRC4DEC1MIX_INPUT_1_SOURCE);
ARIZONA_MUX_ENUMS(ISRC4DEC2, ARIZONA_ISRC4DEC2MIX_INPUT_1_SOURCE);
