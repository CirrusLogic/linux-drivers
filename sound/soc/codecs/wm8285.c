...
SOC_VALUE_ENUM("IN1 OSR", wm8285_in_dmic_osr[0]),
SOC_VALUE_ENUM("IN2 OSR", wm8285_in_dmic_osr[1]),
SOC_VALUE_ENUM("IN3 OSR", wm8285_in_dmic_osr[2]),
SOC_VALUE_ENUM("IN4 OSR", wm8285_in_dmic_osr[3]),
SOC_VALUE_ENUM("IN5 OSR", wm8285_in_dmic_osr[4]),
SOC_VALUE_ENUM("IN6 OSR", wm8285_in_dmic_osr[5]),
...
SOC_VALUE_ENUM("ASRC1 Rate 1", wm8285_asrc1_rate[0]),
SOC_VALUE_ENUM("ASRC1 Rate 2", wm8285_asrc1_rate[1]),
SOC_VALUE_ENUM("ASRC2 Rate 1", wm8285_asrc2_rate[0]),
SOC_VALUE_ENUM("ASRC2 Rate 2", wm8285_asrc2_rate[1]),
...
static const struct soc_enum wm8285_dsp_output_enum =
	SOC_ENUM_SINGLE(0, 0, ARRAY_SIZE(wm8285_dsp_output_texts),
			wm8285_dsp_output_texts);

static const struct snd_kcontrol_new wm8285_dsp_output_mux[] = {
	SOC_DAPM_ENUM_VIRT("DSP Virtual Output Mux", wm8285_dsp_output_enum),
};
...
static const struct soc_enum wm8285_memory_enum =
	SOC_ENUM_SINGLE(0, 0, ARRAY_SIZE(wm8285_memory_mux_texts),
			wm8285_memory_mux_texts);

static const struct snd_kcontrol_new wm8285_memory_mux[] = {
	SOC_DAPM_ENUM_VIRT("DSP2 Virtual Input", wm8285_memory_enum),
	SOC_DAPM_ENUM_VIRT("DSP3 Virtual Input", wm8285_memory_enum),
};
...
static const struct snd_kcontrol_new wm8285_aec_loopback_mux =
	SOC_DAPM_VALUE_ENUM("AEC Loopback", wm8285_aec_loopback);
