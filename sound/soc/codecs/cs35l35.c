				  ...
				  int inductor)
{
	...
	case 1000: /* 1 uH */
		...
		regmap_write(cs35l35->regmap, CS35L35_BST_CONV_COEF_2, 0x24);
		regmap_update_bits(cs35l35->regmap, CS35L35_BST_CONV_SW_FREQ,
		...
		break;
	case 1200: /* 1.2 uH */
		regmap_write(cs35l35->regmap, CS35L35_BST_CONV_COEF_1, 0x20);
		regmap_write(cs35l35->regmap, CS35L35_BST_CONV_COEF_2, 0x20);
		regmap_update_bits(cs35l35->regmap, CS35L35_BST_CONV_SW_FREQ,
	...
	case 1500: /* 1.5uH */
		...
		break;
	case 2200: /* 2.2uH */
		regmap_write(cs35l35->regmap, CS35L35_BST_CONV_COEF_1, 0x19);
		regmap_write(cs35l35->regmap, CS35L35_BST_CONV_COEF_2, 0x25);
		regmap_update_bits(cs35l35->regmap, CS35L35_BST_CONV_SW_FREQ,
				...
				struct cs35l35_platform_data *pdata)
{
	...
	if (of_property_read_u32(np, "cirrus,boost-ind-nanohenry", &val32) >= 0) {
