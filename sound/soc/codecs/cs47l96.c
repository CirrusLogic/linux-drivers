...
TACNA_MIXER_ENUMS(PWM1, TACNA_PWM1_INPUT1);
TACNA_MIXER_ENUMS(PWM2, TACNA_PWM2_INPUT1);
...
SND_SOC_DAPM_MUX("IN2 Mode", SND_SOC_NOPM, 0, 0, &tacna_dmode_mux[1]),
...
static const struct snd_soc_dapm_route cs47l96_dapm_routes[] = {
	...
	{ "IN2L PGA", NULL, "IN2 Mode" },
	{ "IN2R PGA", NULL, "IN2 Mode" },
	{ "IN2 Mode", "Analog", "IN2L Mux" },
	{ "IN2 Mode", "Analog", "IN2R Mux" },
	{ "IN2 Mode", "Digital", "IN2_PDMCLK" },
	{ "IN2 Mode", "Digital", "IN2_PDMDATA" },
