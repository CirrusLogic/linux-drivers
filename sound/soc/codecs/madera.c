			  ...
			  struct snd_soc_dai *dai)
{
	...
	case CS47L93:
		if (base_rate == 0)
			...
			dai_priv->constraint.mask = MADERA_352K8_44K1_RATE_MASK;
		else
	...
	default:
		if (base_rate == 0)
			...
			dai_priv->constraint.mask = MADERA_176K4_44K1_RATE_MASK;
		else
