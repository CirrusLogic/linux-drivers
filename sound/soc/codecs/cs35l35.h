...
#define CS35L35_VPBR_STATUS_LOC_CTL	0x58	/* VPBR Status TX Loc Ctl */
...
/* CS35L35_PWRCTL1 */
#define CS35L35_SFT_RST			(1 << 7)
#define CS35L35_DISCHG_FLT		(1 << 1)
#define CS35L35_PDN_ALL			1

/* CS35L35_PWRCTL2 */
#define CS35L35_PDN_VMON		(1 << 7)
#define CS35L35_PDN_IMON		(1 << 6)
#define CS35L35_PDN_CLASSH		(1 << 5)
#define CS35L35_PDN_VPBR		(1 << 4)
#define CS35L35_PDN_BST			(1 << 2)
#define CS35L35_PDN_AMP			1

/* CS35L35_PWRCTL3 */
#define CS35L35_PDN_VBSTMON_OUT		(1 << 4)
#define CS35L35_PDN_VMON_OUT		(1 << 3)
...
#define CS35L35_CAL_ERR_RLS		(1 << 7)
#define CS35L35_SHORT_RLS		(1 << 2)
#define CS35L35_OTW_RLS			(1 << 1)
#define CS35L35_OTE_RLS			1

/* CS35L35_INT_MASK_1 */
#define CS35L35_M_CAL_ERR_SHIFT		7
#define CS35L35_M_CAL_ERR		(1 << CS35L35_M_CAL_ERR_SHIFT)
#define CS35L35_M_OTP_ERR_SHIFT		6
#define CS35L35_M_OTP_ERR		(1 << CS35L35_M_OTP_ERR_SHIFT)
#define CS35L35_M_LRCLK_ERR_SHIFT	5
#define CS35L35_M_LRCLK_ERR		(1 << CS35L35_M_LRCLK_ERR_SHIFT)
#define CS35L35_M_SPCLK_SHIFT		4
#define CS35L35_M_SPCLK_ERR		(1 << CS35L35_M_SPCLK_SHIFT)
#define CS35L35_M_MCLK_SHIFT		3
#define CS35L35_M_MCLK_ERR		(1 << CS35L35_M_MCLK_SHIFT)
#define CS35L35_M_AMP_SHORT_SHIFT	2
#define CS35L35_M_AMP_SHORT		(1 << CS35L35_M_AMP_SHORT_SHIFT)
#define CS35L35_M_OTW_SHIFT		1
#define CS35L35_M_OTW			(1 << CS35L35_M_OTW_SHIFT)
#define CS35L35_M_OTE_SHIFT		0
#define CS35L35_M_OTE			(1 << CS35L35_M_OTE_SHIFT)

/* CS35L35_INT_MASK_2 */
#define CS35L35_M_PDN_DONE_SHIFT	4
#define CS35L35_M_PDN_DONE		(1 << CS35L35_M_PDN_DONE_SHIFT)
#define CS35L35_M_VPBR_SHIFT		1
#define CS35L35_M_VPBR_ERR		(1 << CS35L35_M_VPBR_SHIFT)
#define CS35L35_M_VPBR_CLR_SHIFT	0
#define CS35L35_M_VPBR_CLR		(1 << CS35L35_M_VPBR_CLR_SHIFT)

/* CS35L35_INT_MASK_3 */
#define CS35L35_M_BST_HIGH_SHIFT	4
#define CS35L35_M_BST_HIGH		(1 << CS35L35_M_BST_HIGH_SHIFT)
#define CS35L35_M_BST_HIGH_FLAG_SHIFT	3
#define CS35L35_M_BST_HIGH_FLAG		(1 << CS35L35_M_BST_HIGH_FLAG_SHIFT)
#define CS35L35_M_BST_IPK_FLAG_SHIFT	2
#define CS35L35_M_BST_IPK_FLAG		(1 << CS35L35_M_BST_IPK_FLAG_SHIFT)
#define CS35L35_M_LBST_SHORT_SHIFT	0
#define CS35L35_M_LBST_SHORT		(1 << CS35L35_M_LBST_SHORT_SHIFT)

/* CS35L35_INT_MASK_4 */
#define CS35L35_M_VMON_OVFL_SHIFT	3
#define CS35L35_M_VMON_OVFL		(1 << CS35L35_M_VMON_OVFL_SHIFT)
#define CS35L35_M_IMON_OVFL_SHIFT	2
#define CS35L35_M_IMON_OVFL		(1 << CS35L35_M_IMON_OVFL_SHIFT)

/* CS35L35_INT_1 */
#define CS35L35_CAL_ERR			(1 << CS35L35_M_CAL_ERR_SHIFT)
#define CS35L35_OTP_ERR			(1 << CS35L35_M_OTP_ERR_SHIFT)
#define CS35L35_LRCLK_ERR		(1 << CS35L35_M_LRCLK_ERR_SHIFT)
#define CS35L35_SPCLK_ERR		(1 << CS35L35_M_SPCLK_ERR_SHIFT)
#define CS35L35_MCLK_ERR		(1 << CS35L35_M_MCLK_SHIFT)
#define CS35L35_AMP_SHORT		(1 << CS35L35_M_AMP_SHORT_SHIFT)
#define CS35L35_OTW			(1 << CS35L35_M_OTW_SHIFT)
#define CS35L35_OTE			(1 << CS35L35_M_OTE_SHIFT)

/* CS35L35_INT_2 */
#define CS35L35_PDN_DONE		(1 << CS35L35_M_PDN_DONE_SHIFT)
#define CS35L35_VPBR_ERR		(1 << CS35L35_M_VPBR_SHIFT)
#define CS35L35_VPBR_CLR		(1 << CS35L35_M_VPBR_CLR_SHIFT)

/* CS35L35_INT_3 */
#define CS35L35_BST_HIGH		(1 << CS35L35_M_BST_HIGH_SHIFT)
#define CS35L35_BST_HIGH_FLAG		(1 << CS35L35_M_BST_HIGH_FLAG_SHIFT)
#define CS35L35_BST_IPK_FLAG		(1 << CS35L35_M_BST_IPK_FLAG_SHIFT)
#define CS35L35_LBST_SHORT		(1 << CS35L35_M_LBST_SHORT_SHIFT)

/* CS35L35_INT_4 */
#define CS35L35_VMON_OVFL		(1 << CS35L35_M_VMON_OVFL_SHIFT)
#define CS35L35_IMON_OVFL		(1 << CS35L35_M_IMON_OVFL_SHIFT)
