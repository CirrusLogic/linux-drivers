...
/* (0xC) contains both RELID and OTPREV */
#define CLSIC_RELID_OTPREV			       0xc
#define CLSIC_RELID_OTPREV_RELID_MASK		0x000000f0
#define CLSIC_RELID_OTPREV_RELID_SHIFT			 4
#define CLSIC_RELID_OTPREV_RELID_WIDTH			 4
#define CLSIC_RELID_OTPREV_OTPREV_MASK		0x0000000f
#define CLSIC_RELID_OTPREV_OTPREV_SHIFT			 0
#define CLSIC_RELID_OTPREV_OTPREV_WIDTH			 4
