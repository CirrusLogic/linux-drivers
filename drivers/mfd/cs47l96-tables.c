...
static const struct reg_default cs47l96_reg_default[] = {
	...
	{ 0x00001d0c, 0x21f05001 }, /* FLL2_CONTROL4 */
	...
	{ 0x00002674, 0x00000001 }, /* LDO1_CONTROL1 */
	...
	{ 0x00003330, 0x00000002 }, /* JACKDET1_COMP_CTRL */
	...
	{ 0x0000c91c, 0x00000001 }, /* ANC_CTRL_11 */
...
int cs47l96_init_spi_regmap(struct spi_device *spi, struct tacna *tacna)
{
	...
	tacna->dsp_regmap[0] = devm_regmap_init_spi(spi,
						    &cs47l96_spi_dsp1_regmap);
	if (IS_ERR(tacna->dsp_regmap[0]))
		return PTR_ERR(tacna->dsp_regmap[0]);

	tacna->dsp_regmap[1] = devm_regmap_init_spi(spi,
						    &cs47l96_spi_dsp1ao_regmap);
