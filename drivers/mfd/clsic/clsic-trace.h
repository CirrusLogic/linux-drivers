...
TRACE_EVENT(clsic_fifo_readmessage,
	...
	TP_fast_assign(
		...
		__entry->cran = clsic_cran_to_char(clsic_get_cran_frommsg(msg))
	),
	TP_printk(
...
TRACE_EVENT(clsic_fifo_readbulk,
	...
	TP_printk("    Transferring bulk read %d", __entry->len)
);
...
TRACE_EVENT(clsic_fifo_writebulk,
	...
	TP_printk("   Transferring bulk write %d (%d remaining)",
		  __entry->len,
		  __entry->totallen
	)
);
...
TRACE_EVENT(clsic_statechange,
	TP_PROTO(enum clsic_states state_from, enum clsic_states state_to),
...
TRACE_EVENT(clsic_ras_simplewrite,
	...
	TP_printk("  addr: 0x%x val: 0x%x ret: %d (err: %d) elapsed: %llu us",
		  __entry->address,
		  __entry->value,
		  __entry->ret,
		  __entry->err,
...
TRACE_EVENT(clsic_ras_fastread,
	...
	TP_printk("   addr: 0x%x val: 0x%x ret: %d elapsed: %llu us",
		  __entry->address,
		  __entry->value,
		  __entry->ret,
		  __entry->elapsed_us
...
TRACE_EVENT(clsic_ras_pm_handler,
	...
	TP_printk("    pm event: %d elapsed: %llu us",
		  __entry->pm_event,
		  __entry->elapsed_us
	)
);
...
TRACE_EVENT(clsic_ras_irq_change,
	...
	TP_printk("  id: %d mode: %d state: %d ret: %d (err: %d)",
		  __entry->irq_id,
		  __entry->mode,
		  __entry->state,
		  __entry->ret,
...
TRACE_EVENT(clsic_msgproc_shutdown_cancel,
	...
	TP_printk("sync: %d, ret = %d", __entry->sync, __entry->ret)
);
...
TRACE_EVENT(clsic_alg_custom_msg,
	...
	TP_printk("    msgid: 0x%x msg len: %zu ret: %d (err: %d)",
		  __entry->msgid,
		  __entry->len,
		  __entry->ret,
		  __entry->err
...
TRACE_EVENT(clsic_alg_set_irq_notify_mode,
	...
	TP_printk("   irq_id: %d irq_mode: %d  ret: %d (err: %d)",
		  __entry->irq_id,
		  __entry->irq_mode,
		  __entry->ret,
		  __entry->err
