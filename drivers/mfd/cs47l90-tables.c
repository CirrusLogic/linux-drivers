/*
 * cs47l90-tables.c  --  data tables for CS47L90 codec
 *
...
static const struct reg_default cs47l90_reva_16_patch[] = {
	{ 0x8A,   0x5555 },
	{ 0x8A,   0xAAAA },
	{ 0x4CF,  0x0730 },
	{ 0x3A2,  0x2438 },
...
static const struct reg_default cs47l90_reg_default[] = {
	...
	{ 0x00000412, 0x0000 }, /* R1042 (0x412) - cs47l90_out1_config */
	...
	{ 0x0000041A, 0x0002 }, /* R1050 (0x41A) - cs47l90_out2_config */
					    ...
					    unsigned int reg)
{
	...
	case MADERA_MICDET2_CONTROL_0:
	case MADERA_MICDET2_CONTROL_1:
	case MADERA_MICDET2_CONTROL_2:
	case MADERA_MICDET2_CONTROL_3:
	case MADERA_MICDET2_CONTROL_4:
	case MADERA_MICDET2_LEVEL_1:
	case MADERA_MICDET2_LEVEL_2:
	case MADERA_MICDET2_LEVEL_3:
	case MADERA_MICDET2_LEVEL_4:
					    ...
					    unsigned int reg)
{
	...
	case MADERA_OTP_HPDET_CALIB_1 ... MADERA_OTP_HPDET_CALIB_2:
	case MADERA_DSP1_CONFIG_1 ... MADERA_DSP1_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
	case MADERA_DSP2_CONFIG_1 ... MADERA_DSP2_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
	case MADERA_DSP3_CONFIG_1 ... MADERA_DSP3_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
	case MADERA_DSP4_CONFIG_1 ... MADERA_DSP4_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
	case MADERA_DSP5_CONFIG_1 ... MADERA_DSP5_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
	case MADERA_DSP6_CONFIG_1 ... MADERA_DSP6_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
	case MADERA_DSP7_CONFIG_1 ... MADERA_DSP7_PMEM_ERR_ADDR_XMEM_ERR_ADDR:
		return true;
	default:
...
const struct regmap_config cs47l90_32bit_spi_regmap = {
	...
	.max_register = MADERA_DSP7_PMEM_ERR_ADDR_XMEM_ERR_ADDR,
