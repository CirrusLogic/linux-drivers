/*
 * marley-tables.c  --  data tables for Marley class codecs
 *
...
static const struct reg_default marley_16_patch[] = {
	{ 0x460, 0x0c40 },
	{ 0x461, 0xcd1a },
	{ 0x462, 0x0c40 },
	{ 0x463, 0xb53b },
...
static const struct regmap_irq marley_irqs[ARIZONA_NUM_IRQ] = {
...
static bool marley_is_adsp_memory(struct device *dev, unsigned int reg)
{
...
static bool marley_16bit_readable_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	...
	case MARLEY_FLL1_SYNCHRONISER_1:
	case MARLEY_FLL1_SYNCHRONISER_2:
	case MARLEY_FLL1_SYNCHRONISER_3:
	case MARLEY_FLL1_SYNCHRONISER_4:
	case MARLEY_FLL1_SYNCHRONISER_5:
	case MARLEY_FLL1_SYNCHRONISER_6:
	case MARLEY_FLL1_SYNCHRONISER_7:
	case MARLEY_FLL1_SPREAD_SPECTRUM:
	case MARLEY_FLL1_GPIO_CLOCK:
	...
	case MARLEY_FRF_COEFFICIENT_4L_1:
	case MARLEY_FRF_COEFFICIENT_4L_2:
	case MARLEY_FRF_COEFFICIENT_4L_3:
	case MARLEY_FRF_COEFFICIENT_4L_4:
	case MARLEY_FRF_COEFFICIENT_5L_1:
	case MARLEY_FRF_COEFFICIENT_5L_2:
	case MARLEY_FRF_COEFFICIENT_5L_3:
	case MARLEY_FRF_COEFFICIENT_5L_4:
	case MARLEY_FRF_COEFFICIENT_5R_1:
	case MARLEY_FRF_COEFFICIENT_5R_2:
	case MARLEY_FRF_COEFFICIENT_5R_3:
...
static bool marley_16bit_volatile_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	case ARIZONA_SOFTWARE_RESET:
	case ARIZONA_DEVICE_REVISION:
...
static bool marley_32bit_readable_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
...
static bool marley_32bit_volatile_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	case ARIZONA_WSEQ_SEQUENCE_1 ... ARIZONA_WSEQ_SEQUENCE_252:
	case MARLEY_OTP_HPDET_CALIB_1 ... MARLEY_OTP_HPDET_CALIB_2:
...
const struct regmap_config marley_16bit_spi_regmap = {
	.name = "marley_16bit",
	.reg_bits = 32,
	.pad_bits = 16,
	.val_bits = 16,
	...
	.max_register = 0x1b00,
	.readable_reg = marley_16bit_readable_register,
	.volatile_reg = marley_16bit_volatile_register,

	.cache_type = REGCACHE_RBTREE,
	.reg_defaults = marley_reg_default,
	.num_reg_defaults = ARRAY_SIZE(marley_reg_default),
};
EXPORT_SYMBOL_GPL(marley_16bit_spi_regmap);

const struct regmap_config marley_16bit_i2c_regmap = {
	.name = "marley_16bit",
	.reg_bits = 32,
	.val_bits = 16,
...
EXPORT_SYMBOL_GPL(marley_16bit_i2c_regmap);

const struct regmap_config marley_32bit_spi_regmap = {
	.name = "marley_32bit",
	.reg_bits = 32,
	.reg_stride = 2,
	.pad_bits = 16,
...
EXPORT_SYMBOL_GPL(marley_32bit_spi_regmap);
...
EXPORT_SYMBOL_GPL(marley_32bit_i2c_regmap);
