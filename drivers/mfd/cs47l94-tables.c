...
static const struct reg_sequence cs47l94_reva_patch[] = {
	...
	{ 0x00017010, 0x00000000 },
	{ 0x00017014, 0x00000000 },
	{ 0x00017018, 0x00000000 },
	{ 0x0001701c, 0x00000000 },
	{ 0x00017020, 0x00000000 },
	{ 0x00017024, 0x00000000 },
	{ 0x00017028, 0x00000000 },
	{ 0x00017030, 0x00000000 },
	{ 0x00017034, 0x00000000 },
	{ 0x00017038, 0x00000000 },
	{ 0x0001703c, 0x00000000 },
	{ 0x00017044, 0x00000000 },
	{ 0x00017048, 0x00000000 },
	{ 0x0001704c, 0x00000000 },
	{ 0x00017110, 0x00000000 },
	{ 0x00017114, 0x00000000 },
	{ 0x00017118, 0x00000000 },
	{ 0x0001711c, 0x00000000 },
	{ 0x00017120, 0x00000000 },
	{ 0x00017124, 0x00000000 },
	{ 0x00017128, 0x00000000 },
	{ 0x0001712c, 0x00000000 },
	{ 0x00017130, 0x00000000 },
	{ 0x00017138, 0x00000000 },
	{ 0x0001713c, 0x00000000 },
	{ 0x00017140, 0x00000000 },
	{ 0x00017144, 0x00000000 },
	{ 0x00017148, 0x00000000 },
	{ 0x0001714c, 0x00000000 },
	{ 0x00017150, 0x00000000 },
	{ 0x00017158, 0x00000000 },
	{ 0x0001715c, 0x00000000 },
	{ 0x00017160, 0x00000000 },
};
...
static const struct reg_default cs47l94_reg_default[] = {
	...
	{ 0x00008120, 0x00800000 }, /* OUT2L_INPUT1 */
	{ 0x00008124, 0x00800000 }, /* OUT2L_INPUT2 */
	{ 0x00008128, 0x00800000 }, /* OUT2L_INPUT3 */
	{ 0x0000812c, 0x00800000 }, /* OUT2L_INPUT4 */
	{ 0x00008130, 0x00800000 }, /* OUT2R_INPUT1 */
	{ 0x00008134, 0x00800000 }, /* OUT2R_INPUT2 */
	{ 0x00008138, 0x00800000 }, /* OUT2R_INPUT3 */
	{ 0x0000813c, 0x00800000 }, /* OUT2R_INPUT4 */
	{ 0x00008140, 0x00800000 }, /* OUTAUX1L_INPUT1 */
	{ 0x00008144, 0x00800000 }, /* OUTAUX1L_INPUT2 */
	{ 0x00008148, 0x00800000 }, /* OUTAUX1L_INPUT3 */
	{ 0x0000814c, 0x00800000 }, /* OUTAUX1L_INPUT4 */
	{ 0x00008150, 0x00800000 }, /* OUTAUX1R_INPUT1 */
	{ 0x00008154, 0x00800000 }, /* OUTAUX1R_INPUT2 */
	{ 0x00008158, 0x00800000 }, /* OUTAUX1R_INPUT3 */
	{ 0x0000815c, 0x00800000 }, /* OUTAUX1R_INPUT4 */
	...
	{ 0x000081c0, 0x00800000 }, /* OUTHL_INPUT1 */
	{ 0x000081c4, 0x00800000 }, /* OUTHL_INPUT2 */
	{ 0x000081c8, 0x00800000 }, /* OUTHL_INPUT3 */
	{ 0x000081cc, 0x00800000 }, /* OUTHL_INPUT4 */
	{ 0x000081d0, 0x00800000 }, /* OUTHR_INPUT1 */
	{ 0x000081d4, 0x00800000 }, /* OUTHR_INPUT2 */
	{ 0x000081d8, 0x00800000 }, /* OUTHR_INPUT3 */
	{ 0x000081dc, 0x00800000 }, /* OUTHR_INPUT4 */
...
static bool cs47l94_readable_register(struct device *dev, unsigned int reg)
{
	...
	case TACNA_OUT2L_INPUT1:
	case TACNA_OUT2L_INPUT2:
	case TACNA_OUT2L_INPUT3:
	case TACNA_OUT2L_INPUT4:
	case TACNA_OUT2R_INPUT1:
	case TACNA_OUT2R_INPUT2:
	case TACNA_OUT2R_INPUT3:
	case TACNA_OUT2R_INPUT4:
	case CS47L94_OUTAUX1L_INPUT1:
	case CS47L94_OUTAUX1L_INPUT2:
	case CS47L94_OUTAUX1L_INPUT3:
	case CS47L94_OUTAUX1L_INPUT4:
	case CS47L94_OUTAUX1R_INPUT1:
	case CS47L94_OUTAUX1R_INPUT2:
	case CS47L94_OUTAUX1R_INPUT3:
	case CS47L94_OUTAUX1R_INPUT4:
	...
	case CS47L94_OUTHL_INPUT1:
	case CS47L94_OUTHL_INPUT2:
	case CS47L94_OUTHL_INPUT3:
	case CS47L94_OUTHL_INPUT4:
	case CS47L94_OUTHR_INPUT1:
	case CS47L94_OUTHR_INPUT2:
	case CS47L94_OUTHR_INPUT3:
	case CS47L94_OUTHR_INPUT4:
	...
	case TACNA_ANC_CTRL_1 ... CS47L94_ANC_L_CTRL_66:
