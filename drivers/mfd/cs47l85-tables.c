/*
 * cs47l85-tables.c  --  data tables for CS47L85 codec
 *
...
static const struct reg_default cs47l85_reva_16_patch[] = {
	{ 0x80,  0x0003 },
	{ 0x213, 0x03E4 },
	{ 0x177, 0x0281 },
	{ 0x197, 0x0281 },
...
static const struct reg_default cs47l85_revc_16_patch[] = {
	{ 0x27E, 0x0000 },
	{ 0x2C2, 0x0005 },
	{ 0x448, 0x003f },
};
...
static const struct reg_default cs47l85_reva_32_patch[] = {
	{  0x3000, 0xC2253632 },
	{  0x3002, 0xC2300001 },
	{  0x3004, 0x8225100E },
	{  0x3006, 0x22251803 },
...
static const struct reg_default cs47l85_revc_32_patch[] = {
	{ 0x3380, 0xE4103066 },
	{ 0x3382, 0xE4103070 },
	{ 0x3384, 0xE4103078 },
	{ 0x3386, 0xE4103080 },
...
{
	int ret = 0;
	const struct reg_default *patch16;
	const struct reg_default *patch32;
...
static const struct reg_default cs47l85_reg_default[] = {
	{ 0x00000008, 0x0309 }, /* R8 (0x08) - Ctrl IF CFG 1 */
	{ 0x00000009, 0x0200 }, /* R9 (0x09) - Ctrl IF CFG 2 */
	{ 0x0000000A, 0x0309 }, /* R10 (0x0A) - Ctrl IF CFG 3 */
	...
	{ 0x0000184F, 0xFFFF }, /* R6222  - IRQ1 Mask 16 */
	{ 0x00001850, 0xFFFF }, /* R6222  - IRQ1 Mask 17 */
	{ 0x00001851, 0xFFFF }, /* R6222  - IRQ1 Mask 18 */
	{ 0x00001852, 0xFFFF }, /* R6222  - IRQ1 Mask 19 */
	{ 0x00001853, 0xFFFF }, /* R6222  - IRQ1 Mask 20 */
	{ 0x00001854, 0xFFFF }, /* R6222  - IRQ1 Mask 21 */
	{ 0x00001855, 0xFFFF }, /* R6222  - IRQ1 Mask 22 */
	{ 0x00001856, 0xFFFF }, /* R6222  - IRQ1 Mask 23 */
	{ 0x00001857, 0xFFFF }, /* R6222  - IRQ1 Mask 24 */
	{ 0x00001858, 0xFFFF }, /* R6222  - IRQ1 Mask 25 */
	{ 0x00001859, 0xFFFF }, /* R6222  - IRQ1 Mask 26 */
	{ 0x0000185A, 0xFFFF }, /* R6222  - IRQ1 Mask 27 */
	{ 0x0000185B, 0xFFFF }, /* R6222  - IRQ1 Mask 28 */
	{ 0x0000185C, 0xFFFF }, /* R6222  - IRQ1 Mask 29 */
	{ 0x0000185D, 0xFFFF }, /* R6222  - IRQ1 Mask 30 */
	{ 0x0000185E, 0xFFFF }, /* R6222  - IRQ1 Mask 31 */
	{ 0x0000185F, 0xFFFF }, /* R6222  - IRQ1 Mask 32 */
					    ...
					    unsigned int reg)
{
	...
	case MADERA_DEVICE_REVISION:
	case MADERA_CTRL_IF_SPI_CFG_1:
	case MADERA_CTRL_IF_I2C1_CFG_1:
	case MADERA_CTRL_IF_I2C2_CFG_1:
	...
	case MADERA_CLAMP_RISE_SEQUENCE_SELECT:
	case MADERA_CLAMP_FALL_SEQUENCE_SELECT:
	...
	case MADERA_MIC_DETECT_1:
	case MADERA_MIC_DETECT_2:
	case MADERA_MIC_DETECT_3:
	case MADERA_MIC_DETECT_4:
	case MADERA_MIC_DETECT_LEVEL_1:
	case MADERA_MIC_DETECT_LEVEL_2:
	case MADERA_MIC_DETECT_LEVEL_3:
	case MADERA_MIC_DETECT_LEVEL_4:
	...
	case MADERA_SPDIFTX1MIX_INPUT_1_SOURCE:
	case MADERA_SPDIFTX1MIX_INPUT_1_VOLUME:
	case MADERA_SPDIFTX2MIX_INPUT_1_SOURCE:
	case MADERA_SPDIFTX2MIX_INPUT_1_VOLUME:
					    ...
					    unsigned int reg)
{
	...
	case CS47L85_OTP_HPDET_CALIB_1 ... CS47L85_OTP_HPDET_CALIB_2:
