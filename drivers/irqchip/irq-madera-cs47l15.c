/*
 * Interrupt support for Cirrus Logic CS47L15
 *
...
static const struct regmap_irq cs47l15_irqs[MADERA_NUM_IRQ] = {
...
const struct regmap_irq_chip cs47l15_irq = {
	.name = "cs47l15 IRQ",
	...
	.num_regs = 33,
	.irqs = cs47l15_irqs,
	.num_irqs = ARRAY_SIZE(cs47l15_irqs),
};
EXPORT_SYMBOL_GPL(cs47l15_irq);
