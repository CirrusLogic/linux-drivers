...
static const struct reg_default cs47l92_low_impedance_patch[] = {
	{ 0x460, 0x0C21 },
	{ 0x461, 0xB53C },
	{ 0x462, 0x0C21 },
	{ 0x463, 0xA186 },
...
static const struct reg_default cs47l92_normal_impedance_patch[] = {
	{ 0x460, 0x0C21 },
	{ 0x461, 0xB53C },
	{ 0x462, 0x0C25 },
	{ 0x463, 0xA186 },
...
static const struct reg_default cs47l92_high_impedance_patch[] = {
	{ 0x460, 0x0C21 },
	{ 0x461, 0xB53C },
	{ 0x462, 0x0C26 },
	{ 0x463, 0xA186 },
				   ...
				   bool clamp)
{
	...
	case CS47L92:
	case CS47L93:
		if (info->pdata->output != 3)
			break;
		/* fall through if this is a muxed output */
	case CS47L15:
	case CS47L35:
		/* check whether audio is routed to EPOUT, do not disable
		 * the primary output in that case */
