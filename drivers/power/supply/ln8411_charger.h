...
#define LN8411_G2_PD_STARTUP_MSK	BIT(1)
#define LN8411_G3_PD_STARTUP_MSK	BIT(0)
#define LN8411_GX_PD_STARTUP_MSK	(LN8411_G2_PD_STARTUP_MSK | \
					 LN8411_G3_PD_STARTUP_MSK)
...
struct ln8411_device {
	...
	struct delayed_work otg_en_work;
