		       ...
		       struct ff_effect *old)
{
	...
	if (check_mul_overflow(effect->u.periodic.custom_len, sizeof(s16), &nbytes))
			return -EOVERFLOW;
	work_data.custom_data = memdup_user(effect->u.periodic.custom_data, nbytes);
