...
struct cs40l26_ls_cal_range ls_cal_ranges[CS40L26_LS_CAL_RANGE_COUNT] = {
	[CS40L26_LS_CAL_RANGE_ID_OL_REDC]	= {
		...
		.min_name	= "RAMS_EXT_OUT_OF_RANGE_OL_RE_MIN",
		.max_name	= "RAMS_EXT_OUT_OF_RANGE_OL_RE_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_LE]		= {
		.name		= "Open Loop LE",
		.dt_prop	= "cirrus,ls-cal-range-ol-le",
		.min_name	= "RAMS_EXT_OUT_OF_RANGE_OL_LE_MIN",
		.max_name	= "RAMS_EXT_OUT_OF_RANGE_OL_LE_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_F0]		= {
		...
		.min_name	= "RAMS_EXT_OUT_OF_RANGE_OL_F0_MIN",
		.max_name	= "RAMS_EXT_OUT_OF_RANGE_OL_F0_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_RES]	= {
		...
		.min_name	= "AMS_EXT_OUT_OF_RANGE_OL_RES_MIN",
		.max_name	= "AMS_EXT_OUT_OF_RANGE_OL_RES_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_Q]		= {
		...
		.min_name	= "ARAMS_EXT_OUT_OF_RANGE_OL_Q_MIN",
		.max_name	= "ARAMS_EXT_OUT_OF_RANGE_OL_Q_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_REDC]	= {
		...
		.min_name	= "RAMS_EXT_OUT_OF_RANGE_CL_RE_MIN",
		.max_name	= "RAMS_EXT_OUT_OF_RANGE_CL_RE_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_LE]		= {
		...
		.min_name	= "RAMS_EXT_OUT_OF_RANGE_CL_LE_MIN",
		.max_name	= "RAMS_EXT_OUT_OF_RANGE_CL_LE_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_F0]		= {
		...
		.min_name	= "RAMS_EXT_OUT_OF_RANGE_CL_F0_MIN",
		.max_name	= "RAMS_EXT_OUT_OF_RANGE_CL_F0_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_RES]	= {
		...
		.min_name	= "AMS_EXT_OUT_OF_RANGE_CL_RES_MIN",
		.max_name	= "AMS_EXT_OUT_OF_RANGE_CL_RES_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_Q]		= {
		...
		.min_name	= "ARAMS_EXT_OUT_OF_RANGE_CL_Q_MIN",
		.max_name	= "ARAMS_EXT_OUT_OF_RANGE_CL_Q_MAX",
		.min		= CS40L26_LS_CAL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_MAX_DEFAULT,
	},
};
