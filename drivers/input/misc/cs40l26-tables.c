...
struct cs40l26_ls_cal_range ls_cal_ranges[CS40L26_LS_CAL_RANGE_COUNT] = {
	[CS40L26_LS_CAL_RANGE_ID_OL_REDC]	= {
		.name		= "Open Loop REDC",
		.dt_prop	= "cirrus,ls-cal-range-ol-redc",
		.min_name	= "PARAMS_EXT_RANGE_OL_RE_MIN",
		.max_name	= "PARAMS_EXT_RANGE_OL_RE_MAX",
		.min		= CS40L26_LS_CAL_REDC_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_REDC_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_LE]		= {
		.name		= "Open Loop LE",
		.dt_prop	= "cirrus,ls-cal-range-ol-le",
		.min_name	= "PARAMS_EXT_RANGE_OL_LE_MIN",
		.max_name	= "PARAMS_EXT_RANGE_OL_LE_MAX",
		.min		= CS40L26_LS_CAL_LE_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_LE_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_F0]		= {
		.name		= "Open Loop F0",
		.dt_prop	= "cirrus,ls-cal-range-ol-f0",
		.min_name	= "PARAMS_EXT_RANGE_OL_F0_MIN",
		.max_name	= "PARAMS_EXT_RANGE_OL_F0_MAX",
		.min		= CS40L26_LS_CAL_F0_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_F0_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_RES]	= {
		.name		= "Open Loop Res",
		.dt_prop	= "cirrus,ls-cal-range-ol-res",
		.min_name	= "PARAMS_EXT_RANGE_OL_RES_MIN",
		.max_name	= "PARAMS_EXT_RANGE_OL_RES_MAX",
		.min		= CS40L26_LS_CAL_RES_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_RES_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_OL_Q]		= {
		.name		= "Open Loop Q",
		.dt_prop	= "cirrus,ls-cal-range-ol-q",
		.min_name	= "PARAMS_EXT_RANGE_OL_Q_MIN",
		.max_name	= "PARAMS_EXT_RANGE_OL_Q_MAX",
		.min		= CS40L26_LS_CAL_Q_OL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_Q_OL_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_REDC]	= {
		.name		= "Closed Loop REDC",
		.dt_prop	= "cirrus,ls-cal-range-cl-redc",
		.min_name	= "PARAMS_EXT_RANGE_CL_RE_MIN",
		.max_name	= "PARAMS_EXT_RANGE_CL_RE_MAX",
		.min		= CS40L26_LS_CAL_REDC_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_REDC_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_LE]		= {
		.name		= "Closed Loop LE",
		.dt_prop	= "cirrus,ls-cal-range-cl-le",
		.min_name	= "PARAMS_EXT_RANGE_CL_LE_MIN",
		.max_name	= "PARAMS_EXT_RANGE_CL_LE_MAX",
		.min		= CS40L26_LS_CAL_LE_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_LE_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_F0]		= {
		.name		= "Closed Loop F0",
		.dt_prop	= "cirrus,ls-cal-range-cl-f0",
		.min_name	= "PARAMS_EXT_RANGE_CL_F0_MIN",
		.max_name	= "PARAMS_EXT_RANGE_CL_F0_MAX",
		.min		= CS40L26_LS_CAL_F0_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_F0_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_RES]	= {
		.name		= "Closed Loop Res",
		.dt_prop	= "cirrus,ls-cal-range-cl-res",
		.min_name	= "PARAMS_EXT_RANGE_CL_RES_MIN",
		.max_name	= "PARAMS_EXT_RANGE_CL_RES_MAX",
		.min		= CS40L26_LS_CAL_RES_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_RES_MAX_DEFAULT,
	},
	[CS40L26_LS_CAL_RANGE_ID_CL_Q]		= {
		.name		= "Closed Loop Q",
		.dt_prop	= "cirrus,ls-cal-range-cl-q",
		.min_name	= "PARAMS_EXT_RANGE_CL_Q_MIN",
		.max_name	= "PARAMS_EXT_RANGE_CL_Q_MAX",
		.min		= CS40L26_LS_CAL_Q_CL_MIN_DEFAULT,
		.max		= CS40L26_LS_CAL_Q_CL_MAX_DEFAULT,
	},
};
EXPORT_SYMBOL_GPL(ls_cal_ranges);
