...
#define CL_DSP_PM_PACKED_NUM_BYTES	5
#define CL_DSP_XM_PACKED_NUM_BYTES	3
#define CL_DSP_XM_UNPACKED_NUM_BYTES	4
#define CL_DSP_YM_PACKED_NUM_BYTES	CL_DSP_XM_PACKED_NUM_BYTES
#define CL_DSP_YM_UNPACKED_NUM_BYTES	CL_DSP_XM_UNPACKED_NUM_BYTES
